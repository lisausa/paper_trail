module PaperTrail
  module Controller
    ...
    # in your `revisions` table, so don't forget to add any new columns
    # you need.
    #
    # For example:
    #
    ...
    #
    # The columns `ip` and `user_agent` must exist in your `revisions` # table.
    #
    ...
    # Tells PaperTrail whether revisions should be saved in the current request.
